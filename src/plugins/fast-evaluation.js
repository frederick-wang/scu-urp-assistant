...
const fastEvaluation = {
  ...
  comments: [
    ...
    '该节课教学重难点把握准确，教学内容主次分明，抓住关键；结构合理，衔接自然紧凑，情感态度与价值观三个维度，符合学段教学要求、教材特点与学生实际，是一节成熟的课',
    '该节课能以旧引新，寻找新旧知识的关联和生长点，注重知识的发生发展过程，能找到教材特点及本课的疑点，并恰当处理，在课堂上设疑问难，引导点拨，是一节很有个性特点的课',
    '本节课各种学习活动设计具体、充分注意学生学习习惯的培养，因材施教，调动学生自主学习的积极性，遵循常规但不拘泥，根据学生的差异和特点，从具体到抽象对教材进行处理，是一节很成功的课',
    '该节课教学过程设计完整有序，既体现知识结构，知识点，又注意突出学生活动设计，体现教学民主、培养学生良好的学习品质，课堂结构完整，密度恰当。',
    '该节课教学程序设计巧妙，在教学过程中能运用上新颖独特教学方法、言简意胲，引导点拨学生，学生动口、动手、动脑，主动参与教学过程，使学生做出的作品图文并貌，有美感，整节课很完美。',
    '该节课很有艺术，教学安排清晰有序，科学规范。在教材处理上从具体到抽象，化难为易，以简驾繁突破难点。各环节有详细的练习，科学合理有效地培养学生自主，探究，创新能力的发展。',
    ...
    '该节课堂结构层次清楚、运用恰当的教学方法和手段启迪学生思维、解决重点、突出难点。精心设计练习，并在整个教学过程中注重学生能力的培养，是一节优秀的课。',
    '该节课很有创意，对教材把握透彻、挖掘深入、处理新颖，针对学生基础和学生发展性目标，设计各种教学活动，引导学生自主学习，有条理地将旧知识综合进行运用。',
    '本节课教学目标包括思想教育要求和知识要求两部分，在课堂教学中注重后进生的补辅，尖子生的拔尖工作，做到对学生动之以情，爱之以诚，使网页比赛取得完美的成果。',
    '该节课教学设计非常巧妙，结合教材特点，学生、教师实际，一法为主，多法配合，优化组合。练习提供了学生喜闻乐见的资料，课堂练习紧扣重点，并注意在“趣”字上下功夫。',
    '该节课教学环节清晰、完整具体，能活化教学内容，使之生活化，课堂教学的开放性、师生关系的民主性、教学模式的多样性，培养学生良好的学习品质，体显出该教师教学能力非常强。',
    '该节课很有特色，创设情景，通过建站，让学生亲自体验、实践、感悟，收集、整理、筛选资料，突出体现了以人为本、以学生发展为本的教育理念。是一节很成功的课。',
    '本节课很有艺术，在教材内容的基础上作了适当的必要的扩展，精心安排学生自主学习、质疑、操作实践等活动以启发式、讨论式为主。学生在完成任务的过和程中学会合作。',
    '该节课重点突出，目标全面、准确、具体，整体现知识与能力、方法与过程、情感态度与价值观三个维度，布局合理，设计各种教学活动，引导学生自主学习，有条理地将旧知识综合进行运用。',
    '该节课堂结构清晰、运用恰当的教学方法和手段启迪学生思维、解决重点、突出难点。根据班级实际情况，精心设计练习，并在整个教学过程中注重因材施教，是一节优秀的课。',
    '该节课十分有创意，教学目的明确，方法得当、语言清晰，具有感染力，习题典型，题量适当，激发学生兴趣，引导自主探究、合作交流完成任务，整个课堂效率非常高。',
    '本节课对教学内容把握透彻、挖掘深入、处理新颖，在课堂教学中，对重难点言简意赅，分析透彻。对练习以思维训练为核心，落实双基，是一节非常成功的课'
  ],
  init () {
